    ...
    $.ajax({
        ...
        success: function( response ) {
			...
			$.each(response.list, function(i, v) {
				...
				var computedResult = (-5.3301887663e-10 * 1) + (30.2722996513 * x0) + (-21.173098399 * x1) + (24.8075983643 * x2) + (2952.20786578 * x3) + (-1996.32171928 * x4) + (386.954618467 * x5) + (-124.656286895 * x6) + (-1.37574286985 * Math.pow(x0, 2)) + (0.27862495285 * x0 * x1) + (0.00841493547958 * x0 * x2) + (-7.63207456732 * x0 * x3) + (22.943620423 * x0 * x4) + (-0.968479450965 * x0 * x5) + (2.85602175005 * x0 * x6) + (3.22743188937 * Math.pow(x1, 2)) + (-0.0453866052884 * x1 * x2) + (-23.5744631331 * x1 * x3) + (25.7366936041 * x1 * x4) + (0.540798506961 * x1 * x5) + (-8.16723477246 *x1 * x6) + (-17.4506750251 * Math.pow(x2, 2)) + (1.52633486328 * x2 * x3) + (7.29465061246 * x2 * x4) + (54.2684463091 * x2 * x5) + (-23.2500035032 * x2 * x6) + (4904.01669115 * Math.pow(x3, 2)) + (-15598.6028973 * x3 * x4) + (-21.9551085857 * x3 * x5) + (1119.64927251 * x3 * x6) + (10410.8160677 * Math.pow(x4, 2)) + (-821.368173676 * x4 * x5) + (-556.682403992 * x4 * x6) + (-247.717691307 * Math.pow(x5, 2)) + (-119.987557116 * x5 * x6) + ( -309.871126173 * Math.pow(x6, 2)) + (-303.154552627);
